...
//
//    private static final String INSERT_FORM = "INSERT INTO RegistrationForm([courseID],[accountID],[birdID],[formStatus])\n"
//            + "VALUES(?,?,?,?)";
//
...
//            + "FROM Course t\n"
//            + "JOIN RegistrationForm r ON t.courseID = r.courseID\n"
...
//                    CourseDTO t = new CourseDTO(courseID, image, courseName, courseStatus, dateTime, fee);
//                    RegistrationFormDTO r = new RegistrationFormDTO(courseID, t);
//                    return r;
//                }
//            }
//        } catch (Exception e) {
...
//                    CourseDTO t = new CourseDTO(courseID, courseName, fee, dateTime, courseStatus);
...
//                    RegistrationFormDTO form = new RegistrationFormDTO(formID, courseID, acc, bird, formStatus);
//                    list.add(form);
//                }
//            }
//        } catch (Exception e) {
