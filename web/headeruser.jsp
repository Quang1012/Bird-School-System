...
-->                                            <li><a href="MainController?action=MANAGE_ACCOUNT">ACCOUNT </a>
                                                ...
                                                <ul class="submenu">
                                                    <li>            
                                                        <a class="nav-link" href="MainController?action=Logout"><i class="fa-solid fa-right-from-bracket"></i>     Logout</a>
                                                    </li> 
                                                </ul>
                                            ...
                                            <li>  <img src="${sessionScope.acc.profilePhoto}" alt="Avatar" class="avatar"></li>   
                                    </nav>
                                </div>
                            </div>
