                            ...
                            <ul> 
                                ...
                                <c:if test="${schedule.slot == 1 }">
                                    <li class="cd-schedule__event">
                                        ...
                                        <a data-start="09:30" data-end="10:30" data-content="event-as-circuit" data-event="event-1" href="#0">
                                            <em class="cd-schedule__name">Slot : ${schedule.slot} - BirdName : ${schedule.birdName}</em>


                                            <em class="cd-schedule__name">
                                                <c:if test="${not empty schedule.className}">
                                                    <%-- Hiển thị tên huấn luyện viên --%>
                                                 CLASS:   ${schedule.className}
                                                </c:if>  
                                                <%-- Nếu không có tên huấn luyện viên --%>
                                                <c:if test="${empty schedule.className}">
                                                    No CLASS
                                                </c:if>
                                            </em>
                                        </a>
