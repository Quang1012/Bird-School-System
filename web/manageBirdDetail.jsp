                    ...
                    <div class="bird-repositoryp-right-card">
                        <div class="card-body main-body-bird">
                            ...
                            <div class="right-main-site">
                                <li>${bird.account.getAccountID()}</li>
                        ...
                        <form action="MainController" method="GET">
                            ...
                            <div class="btn-update-bird">
                                <input type="hidden" value="${bird.getBirdID()}" name="birdID" />
                                <input class="btn btn-success" type="submit" value="UPDATE_BIRD_PAGE" name="action" />
                            </div>
                        </form>
                    </div>
                </div>
