                ...
                <div class="registration-left-site">
                    <div class="registration-inf-form-tnm">
                        <div class="registration-right-heading">
                            <h1>CREATE<br>Course<br>FORM</h1>
                        </div>
                    </div>
                </div>
                <!-- right -site -->
                    ...
                    <div class="registration-right-form">
                        <div class="registration-inf-form-tnm">
                            <div class="mb-3 large-categories">
                                <label class="form-label form-name-categories">Course Name*</label>
                            ...
                            <!-- image section -->
                            <div class="mb-3 large-categories">
                                <label class="form-label form-name-categories upload-label">Course Image:</label>
                                ...
                                <div class="bird-identify-container">
                                    <label for="input-img2" class="preview">
                                        <img class="Course-img" id="previewImg2" src="">
                                    </label>
                        ...
                        <div class="right-button">
                            <button type="submit" name="action" value="CREATE_Course">CREATE</button>
                        </div>
                    </div>
                </form>
            </div>
