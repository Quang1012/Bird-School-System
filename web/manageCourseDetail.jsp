...
<html>
    <head>
        ...
        <link rel="stylesheet" href="CSS/manageCourseDetail.css">
        ...
        <title>Manage Course Detail</title>
    </head>
    <body>  
        <header>
            ...
            <div class="tnm-basic-info">
                ...
                <form action="UpdateCourseController" method="POST">
                    <div class="tnm-heading mt-5">
                        <h1>${requestScope.tour.CourseName}<i class="fa-solid fa-crown"></i></h1>
                        <p>
                            Status: 
                            <c:choose>
                                <c:when test="${requestScope.tour.CourseStatus == 0}">
                                    <select name="CourseStatus">
                                        <option>Coming soon</option>
                                        <option>Open form</option>
                                    </select>
                                </c:when>
                                <c:when test="${requestScope.tour.CourseStatus == 1}">
                                    <select name="CourseStatus">
                                        <option>Open form</option>
                                ...
                                <c:when test="${requestScope.tour.CourseStatus == 2 && requestScope.confirmedForm < requestScope.tour.minParticipant}">
                                    <select name="CourseStatus">
                                        <option>Close form</option>
                            ...
                            <c:when test="${requestScope.tour.CourseStatus == 3 && requestScope.finishCourse eq 'true'}">
                                <select name="CourseStatus">
                                    <option>On Going</option>
                                    <option>Pause</option>
                            ...
                            <c:when test="${requestScope.tour.CourseStatus == 3 && requestScope.finishCourse ne 'true'}">
                                <select name="CourseStatus">
                                    <option>On Going</option>
                                    <option>Pause</option>
                                </select>
                                <p style="color:red;">Finish Top4 to finish Course</p>
                            </c:when>
                            <c:when test="${requestScope.tour.CourseStatus == 4}">
                                <select name="CourseStatus">
                                    <option>Finish</option>
                                </select>
                            </c:when>
                            <c:when test="${requestScope.tour.CourseStatus == 5}">
                                <select name="CourseStatus">
                    ...
                    <div class="right-button">
                        <input type="hidden" value="${requestScope.tour.CourseID}" name="CourseID" />
                        <input type="submit" value="Update Course" name="action">
                    </div>  
                </form>
                <div class="line-section">
                    <p></p>
                </div>
                <c:if test="${requestScope.finishCourse eq 'true'}">
                    <div class="sponsor-site">
                        <a class="custom-button_2" href="LoadCourseRankingController?action=load&CourseID=${requestScope.tour.CourseID}">Ranking</a>
                    </div>
                </c:if>
                <div class="line-section">
                    <p></p>
                                    ...
                                    <div class="basic-tnm-form-categories">
                                        <c:choose>
                                            <c:when test="${requestScope.round.roundID == r.roundID}">
                                                <a style="color:burlywood" id="roud-id" href="ManageRoundController?roundID=${r.roundID}&roundStatus=${r.roundStatus}&roundName=${r.roundName}&CourseID=${tour.CourseID}">${r.roundName}</a><br/>
                                            </c:when>
                                            <c:otherwise>
                                                <a id="roud-id" href="ManageRoundController?roundID=${r.roundID}&roundStatus=${r.roundStatus}&roundName=${r.roundName}&CourseID=${tour.CourseID}">${r.roundName}</a><br/>
                                            </c:otherwise>
                                        </c:choose>
                                        <c:choose>
